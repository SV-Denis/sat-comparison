...
Graphs.py, this script is used in order to create latex graphs, it takes input from the input_data.txt where you will paste your benchmark table made by the main script, it is done this way in order to have the capacity to combine multiple tables into 1 graph
